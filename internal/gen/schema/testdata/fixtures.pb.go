...
type OneofArmRequired struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Target:
	//
	//	*OneofArmRequired_Id
	//	*OneofArmRequired_Name
	Target        isOneofArmRequired_Target `protobuf_oneof:"target"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *OneofArmRequired) Reset() {
	*x = OneofArmRequired{}
...
func (x *OneofArmRequired) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OneofArmRequired) ProtoMessage() {}

func (x *OneofArmRequired) ProtoReflect() protoreflect.Message {
	mi := &file_fixtures_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OneofArmRequired.ProtoReflect.Descriptor instead.
func (*OneofArmRequired) Descriptor() ([]byte, []int) {
	return file_fixtures_proto_rawDescGZIP(), []int{13}
}

func (x *OneofArmRequired) GetTarget() isOneofArmRequired_Target {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *OneofArmRequired) GetId() string {
	if x != nil {
		if x, ok := x.Target.(*OneofArmRequired_Id); ok {
			return x.Id
		}
	}
	return ""
...
func (x *OneofArmRequired) GetName() string {
	if x != nil {
		if x, ok := x.Target.(*OneofArmRequired_Name); ok {
			return x.Name
		}
	}
	return ""
...
type isOneofArmRequired_Target interface {
	isOneofArmRequired_Target()
}

type OneofArmRequired_Id struct {
	Id string `protobuf:"bytes,1,opt,name=id,proto3,oneof"`
}

type OneofArmRequired_Name struct {
	Name string `protobuf:"bytes,2,opt,name=name,proto3,oneof"`
}

func (*OneofArmRequired_Id) isOneofArmRequired_Target() {}
...
type ZeroBreakers struct {
	...
	LenBytesS         string                 `protobuf:"bytes,17,opt,name=len_bytes_s,json=lenBytesS,proto3" json:"len_bytes_s,omitempty"`
	NotContainsEmptyS string                 `protobuf:"bytes,18,opt,name=not_contains_empty_s,json=notContainsEmptyS,proto3" json:"not_contains_empty_s,omitempty"`
	OkEmailDisabled   string                 `protobuf:"bytes,19,opt,name=ok_email_disabled,json=okEmailDisabled,proto3" json:"ok_email_disabled,omitempty"`
	OkUriRef          string                 `protobuf:"bytes,20,opt,name=ok_uri_ref,json=okUriRef,proto3" json:"ok_uri_ref,omitempty"`
	OkHttpHeaderValue string                 `protobuf:"bytes,21,opt,name=ok_http_header_value,json=okHttpHeaderValue,proto3" json:"ok_http_header_value,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ZeroBreakers) GetLenBytesS() string {
	if x != nil {
		return x.LenBytesS
	}
	return ""
...
func (x *ZeroBreakers) GetNotContainsEmptyS() string {
	if x != nil {
		return x.NotContainsEmptyS
	}
	return ""
}

func (x *ZeroBreakers) GetOkEmailDisabled() string {
	if x != nil {
		return x.OkEmailDisabled
	}
	return ""
}

func (x *ZeroBreakers) GetOkUriRef() string {
	if x != nil {
		return x.OkUriRef
	}
	return ""
...
func (x *ZeroBreakers) GetOkHttpHeaderValue() string {
	if x != nil {
		return x.OkHttpHeaderValue
	}
	return ""
}
...
const file_fixtures_proto_rawDesc = "" +
	...
	"\x06secret\x12\x05\xbaH\x02\b\x01\"L\n" +
	...
	"\x11req_ignore_always\x18\x10 \x01(\tB\t\xbaH\x06\xc8\x01\x01\xd8\x01\x03R\x0freqIgnoreAlways\x12(\n" +
	"\vlen_bytes_s\x18\x11 \x01(\tB\b\xbaH\x05r\x03\xa0\x01\x01R\tlenBytesS\x129\n" +
	"\x14not_contains_empty_s\x18\x12 \x01(\tB\b\xbaH\x05r\x03\xba\x01\x00R\x11notContainsEmptyS\x123\n" +
	"\x11ok_email_disabled\x18\x13 \x01(\tB\a\xbaH\x04r\x02`\x00R\x0fokEmailDisabled\x12&\n" +
	"\n" +
	"ok_uri_ref\x18\x14 \x01(\tB\b\xbaH\x05r\x03\x90\x01\x01R\bokUriRef\x129\n" +
	"\x14ok_http_header_value\x18\x15 \x01(\tB\b\xbaH\x05r\x03\xc0\x01\x02R\x11okHttpHeaderValue\x1a<\n" +
...
func file_fixtures_proto_init() {
	...
	file_fixtures_proto_msgTypes[13].OneofWrappers = []any{
