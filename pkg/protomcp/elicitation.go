...
//
// The value is a plain content hash, not an authenticator: a client
// willing to lie about the user's answer can compute it. Elicitation is
// a UX confirmation for honest clients, not a server-enforced
// authorization control — enforce authorization server-side.
